        ...
        <div class="col-md-6 col-lg-5">
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <h1 class="h4 mb-3">Admin Register</h1>
                    <p class="text-muted small">Register the first admin account for this portal.</p>
                    ...
                    <form method="post" action="<?= site_url('admin/register') ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="confirm_password" id="confirm_password" class="form-control <?= $validation && $validation->hasError('confirm_password') ? 'is-invalid' : '' ?>">
