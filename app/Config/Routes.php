...
$routes->get('admin/records/export', 'Admin::exportRecords');
$routes->get('admin/records/import', 'Admin::importRecordsPage');
$routes->get('admin/records/import/template', 'Admin::downloadImportTemplate');
$routes->post('admin/records/import', 'Admin::importRecordsUpload');
$routes->get('admin/students/create', 'Admin::createStudent');
$routes->get('admin/students/view/(:num)', 'Admin::viewStudent/$1');
